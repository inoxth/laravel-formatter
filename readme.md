## Attention!
This fork was made to support encoding and '@attributes' and '@value' in xml, so that nodes (xml tags) could support attributes and native string nodes. _Any credits should go to the original author of this bundle._
